...
class RealEstateDashboardUIKitSupabaseUser extends BaseAuthUser {
  RealEstateDashboardUIKitSupabaseUser(this.user);
  User? user;
...
Stream<BaseAuthUser> realEstateDashboardUIKitSupabaseUserStream() {
  ...
  return (!loggedIn
    ...
    (authState) {
      currentUser =
          RealEstateDashboardUIKitSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
