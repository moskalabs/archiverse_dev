...
class StudentLectureMaterialWidget extends StatefulWidget {
  const StudentLectureMaterialWidget({super.key});

  static String routeName = 'StudentLectureMaterial';
  static String routePath = '/StudentLectureMaterial';

  @override
  State<StudentLectureMaterialWidget> createState() =>
      _StudentLectureMaterialWidgetState();
}

class _StudentLectureMaterialWidgetState
    extends State<StudentLectureMaterialWidget> {
  late StudentLectureMaterialModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StudentLectureMaterialModel());
                    ...
                    if (responsiveVisibility(
                      ...
                      wrapWithModel(
                        ...
                        child: StudentNaviSidebarWidget(
                          activePageName: 'Student_LectureMaterial',
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          Builder(
                                                                            builder:
                                                                                (context) {
                                                                              final lectureList = _model.lecturematerialList.map((e) => e).toList();
                                                                              ...
                                                                              return ListView.builder(
                                                                                ...
                                                                                itemBuilder: (context, lectureListIndex) {
                                                                                  final lectureListItem = lectureList[lectureListIndex];
                                                                                  return LectureListRowWidget(
                                                                                    key: Key('Keyw45_${lectureListIndex}_of_${lectureList.length}'),
                                                                  ...
                                                                  builder:
                                                                    ...
                                                                    return ListView
                                                                      ...
                                                                      itemBuilder:
                                                                        ...
                                                                        return LectureListRowWidget(
                                                                          key: Key(
                                                                              'Keyers_${lectureListIndex}_of_${lectureList.length}'),
                                                                          lectureList:
                                                                              lectureListItem,
                                                                          selectedLectureId:
                                                                              _model.selectedIndex!,
