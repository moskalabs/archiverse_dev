...
import 'student_course_plan_model.dart';
import '/core/responsive_wrapper.dart';
export 'student_course_plan_model.dart';

class StudentCoursePlanWidget extends StatefulWidget {
  const StudentCoursePlanWidget({super.key});

  static String routeName = 'StudentCoursePlan';
  static String routePath = '/StudentCoursePlan';

  @override
  State<StudentCoursePlanWidget> createState() =>
      _StudentCoursePlanWidgetState();
}

class _StudentCoursePlanWidgetState extends State<StudentCoursePlanWidget> {
  late StudentCoursePlanModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StudentCoursePlanModel());
                    ...
                    children: [
                      wrapWithModel(
                          ...
                          child: StudentNaviSidebarWidget(
                            activePageName: 'Student_CoursePlan',
                                                                                            ...
                                                                                            child: WebViewAware(
                                                                                              child: GestureDetector(
                                                                                                ...
                                                                                                child: DownloadPopUpWidget(
                                                                                                  downloadType: '수업계획서',
                                                                                                  titleName: _model.courseplanrow!.firstOrNull!.planTitle!,
                                                                                                  url: valueOrDefault<String>(
                                                                                                    _model.courseplanrow?.firstOrNull?.url,
                                                                                                    'd',
                                                                                                  ),
                                                                                                ),
                                                                                              ),
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                Stack(
                                                                              children: [
                                                                                if (_model.courseplanrow != null && (_model.courseplanrow)!.isNotEmpty)
                                                                                ...
                                                                                if (_model.courseplanrow?.firstOrNull == null)
                                                                                  Align(
                                                          ...
                                                          Flexible(
                                                            child: Padding(
                                                              ...
                                                              child: Container(
                                                                ...
                                                                child: Stack(
                                                                  children: [
                                                                    if (_model.courseplanrow !=
                                                                            null &&
                                                                        (_model.courseplanrow)!
                                                                            .isNotEmpty)
                                                                      FlutterFlowPdfViewer(
                                                                        networkPath:
