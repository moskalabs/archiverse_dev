...
import 'admin_portfolio_widget.dart' show AdminPortfolioWidget;
import 'package:flutter/material.dart';

class AdminPortfolioModel extends FlutterFlowModel<AdminPortfolioWidget> {
  ...
  PortfolioType? selectedPortfolioType = PortfolioType.portfolio;

  String? selectedWeek;

  int? selectedStudentId;

  List<SubjectportpolioRow> selectedPortfolio = [];
  void addToSelectedPortfolio(SubjectportpolioRow item) =>
      selectedPortfolio.add(item);
  void removeFromSelectedPortfolio(SubjectportpolioRow item) =>
      selectedPortfolio.remove(item);
  void removeAtIndexFromSelectedPortfolio(int index) =>
      selectedPortfolio.removeAt(index);
  void insertAtIndexInSelectedPortfolio(int index, SubjectportpolioRow item) =>
      selectedPortfolio.insert(index, item);
  void updateSelectedPortfolioAtIndex(
          int index, Function(SubjectportpolioRow) updateFn) =>
      selectedPortfolio[index] = updateFn(selectedPortfolio[index]);

  String? selectedStudentName;

  PortfolioViewType? portfolioViewType = PortfolioViewType.portfolio_overview;

  List<ClassRow> selectedClassDetail = [];
  void addToSelectedClassDetail(ClassRow item) => selectedClassDetail.add(item);
  void removeFromSelectedClassDetail(ClassRow item) =>
      selectedClassDetail.remove(item);
  void removeAtIndexFromSelectedClassDetail(int index) =>
      selectedClassDetail.removeAt(index);
  void insertAtIndexInSelectedClassDetail(int index, ClassRow item) =>
      selectedClassDetail.insert(index, item);
  void updateSelectedClassDetailAtIndex(
          int index, Function(ClassRow) updateFn) =>
      selectedClassDetail[index] = updateFn(selectedClassDetail[index]);

  bool isSearching = false;

  ///  State fields for stateful widgets in this page.

  // Stores action output result for [Backend Call - Query Rows] action in AdminPortfolio widget.
  ...
  // Stores action output result for [Backend Call - Query Rows] action in portfolio_ClassContainer widget.
  List<SubjectportpolioRow>? queryPortfolio;
  // Model for portfolioTypeChip component.
  late PortfolioTypeChipModel portfolioTypeChipModel1;
  // Model for portfolioTypeChip component.
  late PortfolioTypeChipModel portfolioTypeChipModel2;
  // Model for portfolioTypeChip component.
  late PortfolioTypeChipModel portfolioTypeChipModel3;
  // Model for weekChip component.
  late WeekChipModel weekChipModel1;
  // Model for weekChip component.
  late WeekChipModel weekChipModel2;
  // Model for weekChip component.
  late WeekChipModel weekChipModel3;
  // Model for weekChip component.
  late WeekChipModel weekChipModel4;
  // Model for weekChip component.
  late WeekChipModel weekChipModel5;
  // Model for weekChip component.
  late WeekChipModel weekChipModel6;
  // Model for weekChip component.
  late WeekChipModel weekChipModel7;
  // Model for weekChip component.
  late WeekChipModel weekChipModel8;
  // Model for weekChip component.
  late WeekChipModel weekChipModel9;
  // Model for weekChip component.
  late WeekChipModel weekChipModel10;
  // Model for weekChip component.
  late WeekChipModel weekChipModel11;
  // Model for weekChip component.
  late WeekChipModel weekChipModel12;
  // Model for weekChip component.
  late WeekChipModel weekChipModel13;
  // Model for weekChip component.
  late WeekChipModel weekChipModel14;
  // Model for weekChip component.
  late WeekChipModel weekChipModel15;
  ...
  // State field(s) for WeekDropDown widget.
  String? weekDropDownValue;
  FormFieldController<String>? weekDropDownValueController;
  // State field(s) for TextField widget.
  ...
  // Model for ResultsRow_Mobile component.
  late ResultsRowMobileModel resultsRowMobileModel;
  // Model for Borderline component.
  ...
  void initState(BuildContext context) {
    ...
    portfolioTypeChipModel1 =
        createModel(context, () => PortfolioTypeChipModel());
    portfolioTypeChipModel2 =
        createModel(context, () => PortfolioTypeChipModel());
    portfolioTypeChipModel3 =
        createModel(context, () => PortfolioTypeChipModel());
    weekChipModel1 = createModel(context, () => WeekChipModel());
    weekChipModel2 = createModel(context, () => WeekChipModel());
    weekChipModel3 = createModel(context, () => WeekChipModel());
    weekChipModel4 = createModel(context, () => WeekChipModel());
    weekChipModel5 = createModel(context, () => WeekChipModel());
    weekChipModel6 = createModel(context, () => WeekChipModel());
    weekChipModel7 = createModel(context, () => WeekChipModel());
    weekChipModel8 = createModel(context, () => WeekChipModel());
    weekChipModel9 = createModel(context, () => WeekChipModel());
    weekChipModel10 = createModel(context, () => WeekChipModel());
    weekChipModel11 = createModel(context, () => WeekChipModel());
    weekChipModel12 = createModel(context, () => WeekChipModel());
    weekChipModel13 = createModel(context, () => WeekChipModel());
    weekChipModel14 = createModel(context, () => WeekChipModel());
    weekChipModel15 = createModel(context, () => WeekChipModel());
    ...
    resultsRowMobileModel = createModel(context, () => ResultsRowMobileModel());
  ...
  void dispose() {
    ...
    portfolioTypeChipModel1.dispose();
    portfolioTypeChipModel2.dispose();
    portfolioTypeChipModel3.dispose();
    weekChipModel1.dispose();
    weekChipModel2.dispose();
    weekChipModel3.dispose();
    weekChipModel4.dispose();
    weekChipModel5.dispose();
    weekChipModel6.dispose();
    weekChipModel7.dispose();
    weekChipModel8.dispose();
    weekChipModel9.dispose();
    weekChipModel10.dispose();
    weekChipModel11.dispose();
    weekChipModel12.dispose();
    weekChipModel13.dispose();
    weekChipModel14.dispose();
    weekChipModel15.dispose();
  ...
  Future filterDataByGrade(BuildContext context) async {
    ...
    filteredClass = classSelectedOnLoad!
        ...
        .toList()
        .cast<ClassRow>();
    studentsByGrade = allStudents.toList().cast<CourseStudentRow>();
  }
  ...
  Future filterPortfolio(BuildContext context) async {
    if ((selectedStudentName != null && selectedStudentName != '') &&
      ...
      selectedPortfolio = allPortfolio
          .where((e) =>
              (e.week == selectedWeek) &&
              (e.studentName == selectedStudentName))
          .toList()
          .toList()
          .cast<SubjectportpolioRow>();
    } else {
      await actions.failDebug();
    }
  }
}
