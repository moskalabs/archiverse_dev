...
import '/components/popups/attendance_delete_pop_up/attendance_delete_pop_up_widget.dart';
import '/components/popups/attendance_upload_pop_up/attendance_upload_pop_up_widget.dart';
...
class ProfAttendanceSheetWidget extends StatefulWidget {
  const ProfAttendanceSheetWidget({super.key});

  static String routeName = 'Prof_AttendanceSheet';
  static String routePath = '/AttendanceSheet';

  @override
  State<ProfAttendanceSheetWidget> createState() =>
      _ProfAttendanceSheetWidgetState();
}

class _ProfAttendanceSheetWidgetState extends State<ProfAttendanceSheetWidget> {
  late ProfAttendanceSheetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfAttendanceSheetModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.attendancerow = await AttendanceTable().queryRows(
        queryFn: (q) => q.eqOrNull(
          'class',
          FFAppState().classSelectedID,
        ),
      );
      _model.attenList = _model.attendancerow?.firstOrNull;
      safeSetState(() {});
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            builder: (context) =>
                                                                              ...
                                                                              child: FFButtonWidget(
                                                                                onPressed: () async {
                                                                                  if (_model.attenList?.title == null || _model.attenList?.title == '') {
                                                                                    await showDialog(
                                                                                      context: context,
                                                                                      builder: (dialogContext) {
                                                                                        return Dialog(
                                                                                          ...
                                                                                          child: WebViewAware(
                                                                                            child: GestureDetector(
                                                                                              ...
                                                                                              child: AttendanceUploadPopUpWidget(
                                                                                                fileType: '출석부',
                                                                                                filePath: 'attendance',
                                                                                              ),
                                                                                            ),
                                                                                    ...
                                                                                    ).then((value) => safeSetState(() => _model.attenListReturn = value));

                                                                                    _model.uploadClicked = true;
                                                                                    _model.attenList = _model.attenListReturn;
                                                                                    safeSetState(() {});
                                                                                  } else {
                                                                                    await showDialog(
                                                                                      context: context,
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              onPressed: () async {
                                                                                if (_model.attenList?.title == null || _model.attenList?.title == '') {
                                                                                      ...
                                                                                      return Dialog(
                                                                                        ...
                                                                                        child: WebViewAware(
                                                                                          child: GestureDetector(
                                                                                            ...
                                                                                            child: AttendanceDeletePopUpWidget(
                                                                                              text: '출석부',
                                                                                            ),
                                                                                          ),
                                                                                        ),
                                                                                  ...
                                                                                  if (FFAppState().attendanceUploadURLUse == '') {
                                                                                    _model.deleteClicked = true;
                                                                                    _model.uploadClicked = false;
                                                                                    _model.attenList = null;
                                                                                    safeSetState(() {});
                                                                                  }
                                                                                }
                                                                              },
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onPressed:
                                                                              ...
                                                                              if (_model.attenList?.title == null || _model.attenList?.title == '') {
                                                                                ...
                                                                                ).then((value) => safeSetState(() => _model.attenListReturnMobile = value));

                                                                                _model.uploadClicked = true;
                                                                                _model.attenList = _model.attenListReturnMobile;
                                                                                safeSetState(() {});
                                                                              } else {
                                                                                await showDialog(
                                                                                  context: context,
                                                                    ...
                                                                    Builder(
                                                                      builder:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onPressed:
                                                                              () async {
                                                                            if (_model.attenList?.title == null ||
                                                                                _model.attenList?.title == '') {
                                                                              await showDialog(
                                                                                context: context,
                                                                                builder: (alertDialogContext) {
