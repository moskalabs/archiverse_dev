...
import '/index.dart';
import 'admin_dash_backup_widget.dart' show AdminDashBackupWidget;
import 'package:flutter/material.dart';

class AdminDashBackupModel extends FlutterFlowModel<AdminDashBackupWidget> {
  ...
  // Stores action output result for [Backend Call - Query Rows] action in AdminDashBackup widget.
  ...
  // State field(s) for CourseSelectionDropDown widget.
  String? courseSelectionDropDownValue;
  FormFieldController<String>? courseSelectionDropDownValueController;
