...
class GradesheetTable extends SupabaseTable<GradesheetRow> {
  @override
  String get tableName => 'gradesheet';

  @override
  GradesheetRow createRow(Map<String, dynamic> data) => GradesheetRow(data);
}

class GradesheetRow extends SupabaseDataRow {
  GradesheetRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => GradesheetTable();
