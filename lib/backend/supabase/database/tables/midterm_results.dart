...
class MidtermResultsTable extends SupabaseTable<MidtermResultsRow> {
  @override
  String get tableName => 'midterm_results';

  @override
  MidtermResultsRow createRow(Map<String, dynamic> data) =>
      MidtermResultsRow(data);
}

class MidtermResultsRow extends SupabaseDataRow {
  MidtermResultsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => MidtermResultsTable();
