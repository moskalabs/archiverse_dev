...
/// 학생별 중간결과물 표지 템플릿
class StudentMidtermCoverTemplate {
  ...
  /// 학생별 중간결과물 표지 페이지를 finalDoc에 추가
  static Future<void> addStudentCoverPage({
    ...
    try {
      print('$studentName 중간결과물 표지 생성 시작');
      ...
      print('$studentName 중간결과물 표지 생성 완료');
      
    } catch (e) {
      print('$studentName 중간결과물 표지 생성 실패: $e');
    }
  }
}