...
/// 기말결과물 표지 템플릿 (학생 목록 포함)
class FinalResultsCoverTemplate {
  ...
  /// 기말결과물 표지 페이지를 finalDoc에 추가하고 학생 목록 반환
  static Future<List<String>> addFinalResultsCover({
    ...
    try {
      print('======= 기말결과물 표지 생성 시작 =======');
      updateProgress(startProgress, '기말결과물 표지 생성 중');
      
      // final_results 테이블에서 해당 분반 학생 목록 조회 (중복 제거)
      ...
      if (classId != null) {
        try {
          ...
          print('${section ?? '분반'} 기말결과물 학생 수: ${studentNames.length}명 (총 결과물: ${finalResults.length}개)');
          print('학생 목록: ${studentNames.join(', ')}');
        } catch (e) {
          print('기말결과물 학생 목록 조회 실패: $e');
              ...
              pw.Row(
                ...
                children: [
                  pw.Row(children: [
                    ...
                    pw.Text('최종 결과물', style: pw.TextStyle(
      ...
      updateProgress(endProgress, '기말결과물 표지 완료');
      print('======= 기말결과물 표지 생성 완료 =======');
      print('학생 수: ${studentNames.length}명');
      
      return studentNames; // 학생 목록 반환
      
    } catch (e) {
      print('기말결과물 표지 생성 실패: $e');
      updateProgress(endProgress, '기말결과물 표지 생성 실패');
