...
import 'student_navi_sidebar_model.dart';
export 'student_navi_sidebar_model.dart';

class StudentNaviSidebarWidget extends StatefulWidget {
  const StudentNaviSidebarWidget({
    super.key,
  ...
  @override
  State<StudentNaviSidebarWidget> createState() =>
      _StudentNaviSidebarWidgetState();
}

class _StudentNaviSidebarWidgetState extends State<StudentNaviSidebarWidget> {
  late StudentNaviSidebarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StudentNaviSidebarModel());
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      context.pushNamed(
                                        StudentLectureMaterialWidget.routeName,
                                        extra: <String, dynamic>{
                                          kTransitionInfoKey: TransitionInfo(
                                            hasTransition: true,
                                            transitionType:
