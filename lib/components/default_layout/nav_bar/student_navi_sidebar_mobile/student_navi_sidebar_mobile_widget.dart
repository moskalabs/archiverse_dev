...
import 'student_navi_sidebar_mobile_model.dart';
export 'student_navi_sidebar_mobile_model.dart';

class StudentNaviSidebarMobileWidget extends StatefulWidget {
  const StudentNaviSidebarMobileWidget({
    super.key,
  ...
  @override
  State<StudentNaviSidebarMobileWidget> createState() =>
      _StudentNaviSidebarMobileWidgetState();
}

class _StudentNaviSidebarMobileWidgetState
    extends State<StudentNaviSidebarMobileWidget> {
  late StudentNaviSidebarMobileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StudentNaviSidebarMobileModel());
          ...
          child: Visibility(
            ...
            child: Align(
              ...
              child: AnimatedContainer(
                ...
                width: FFAppState().studentNavbarMobile == true ? 230.0 : 50.0,
                height: FFAppState().studentNavbarMobile == true ? 810.0 : 65.0,
                            ...
                            child: Row(
                              ...
                              children: [
                                Flexible(
                                  child: Container(
                                    width:
                                        FFAppState().studentNavbarMobile == true
                                            ? 200.0
                                            : 50.0,
                                    height:
                                        FFAppState().studentNavbarMobile == true
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        if (FFAppState().studentNavbarMobile ==
                                            true)
                                          Expanded(
                                            flex: 1,
                                            child: Padding(
