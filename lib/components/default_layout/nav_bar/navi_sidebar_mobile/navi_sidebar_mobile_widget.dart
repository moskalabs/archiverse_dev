...
import 'navi_sidebar_mobile_model.dart';
export 'navi_sidebar_mobile_model.dart';

class NaviSidebarMobileWidget extends StatefulWidget {
  const NaviSidebarMobileWidget({
    super.key,
  ...
  @override
  State<NaviSidebarMobileWidget> createState() =>
      _NaviSidebarMobileWidgetState();
}

class _NaviSidebarMobileWidgetState extends State<NaviSidebarMobileWidget> {
  late NaviSidebarMobileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NaviSidebarMobileModel());
          ...
          child: Visibility(
            ...
            child: Align(
              ...
              child: AnimatedContainer(
                ...
                width: FFAppState().navbarMobile == true ? 230.0 : 50.0,
                height: FFAppState().navbarMobile == true ? 810.0 : 65.0,
                          ...
                          Flexible(
                            ...
                            child: Row(
                              ...
                              children: [
                                Flexible(
                                  child: Container(
                                    width: FFAppState().navbarMobile == true
                                        ? 200.0
                                        : 50.0,
                                    height: FFAppState().navbarMobile == true
                                        ? 120.0
                                        : 45.0,
                                    decoration: BoxDecoration(),
                                    child: Column(
