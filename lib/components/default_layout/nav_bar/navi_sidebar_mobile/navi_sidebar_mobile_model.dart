...
import 'navi_sidebar_mobile_widget.dart' show NaviSidebarMobileWidget;
import 'package:flutter/material.dart';

class NaviSidebarMobileModel extends FlutterFlowModel<NaviSidebarMobileWidget> {
  ...
  // Model for MenuItem component.
  late MenuItemModel menuItemModel9;
  // Model for MenuItem component.
  late MenuItemModel menuItemModel10;
  // Model for MenuItem component.
  late MenuItemModel menuItemModel11;
  // Model for MenuItem component.
  late MenuItemModel menuItemModel12;
  ...
  void initState(BuildContext context) {
    ...
    menuItemModel9 = createModel(context, () => MenuItemModel());
    menuItemModel10 = createModel(context, () => MenuItemModel());
    menuItemModel11 = createModel(context, () => MenuItemModel());
    menuItemModel12 = createModel(context, () => MenuItemModel());
  }
  ...
  void dispose() {
    ...
    menuItemModel9.dispose();
    menuItemModel10.dispose();
    menuItemModel11.dispose();
    menuItemModel12.dispose();
  }
}
