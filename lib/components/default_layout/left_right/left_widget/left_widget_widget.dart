...
import 'left_widget_model.dart';
export 'left_widget_model.dart';

class LeftWidgetWidget extends StatefulWidget {
  const LeftWidgetWidget({super.key});

  @override
  State<LeftWidgetWidget> createState() => _LeftWidgetWidgetState();
}
...
class _LeftWidgetWidgetState extends State<LeftWidgetWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LeftWidgetModel());
