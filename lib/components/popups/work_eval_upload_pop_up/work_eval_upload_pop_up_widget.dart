...
import 'work_eval_upload_pop_up_model.dart';
export 'work_eval_upload_pop_up_model.dart';

class WorkEvalUploadPopUpWidget extends StatefulWidget {
  const WorkEvalUploadPopUpWidget({
    super.key,
    String? text,
  ...
  @override
  State<WorkEvalUploadPopUpWidget> createState() =>
      _WorkEvalUploadPopUpWidgetState();
}

class _WorkEvalUploadPopUpWidgetState extends State<WorkEvalUploadPopUpWidget> {
  late WorkEvalUploadPopUpModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WorkEvalUploadPopUpModel());
  ...
  void dispose() {
    ...
    () async {
      FFAppState().workEvalUploadFileURL = '';
      safeSetState(() {});
    }();
                    ...
                    children: [
                      if ((_model.fileUpload == false) &&
                        ...
                        InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            _model.workevalcheck =
                                await WorkevalformTable().queryRows(
                              queryFn: (q) => q
                                  .eqOrNull(
                                    'class',
                            ...
                            if (_model.workevalcheck?.firstOrNull == null) {
                              ...
                              if (selectedFiles != null) {
                                safeSetState(() => _model
                                    .isDataUploading_uploadData943 = true);
                                ...
                                try {
                                  ...
                                  ScaffoldMessenger.of(context)
                                      .hideCurrentSnackBar();
                                  _model.isDataUploading_uploadData943 = false;
                                }
                                if (selectedUploadedFiles.length ==
                                    ...
                                    downloadUrls.length ==
                                        selectedFiles.length) {
                                  safeSetState(() {
                                    _model.uploadedLocalFile_uploadData943 =
                                        selectedUploadedFiles.first;
                                    _model.uploadedFileUrl_uploadData943 =
                                        downloadUrls.first;
                                  });
                                  showUploadMessage(
                                    context,
                              ...
                              FFAppState().workEvalUploadFileURL =
                                  _model.uploadedFileUrl_uploadData943;
                              if (FFAppState().workEvalUploadFileURL == '') {
                                await showDialog(
                                  context: context,
                                ...
                                children: [
                                  ...
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'pie5nljk' /* Drop image here, or Browse */,
                                    ),
                      ...
                      if (_model.fileUpload == true)
                        FlutterFlowPdfViewer(
                          networkPath: _model.uploadedFileUrl_uploadData943,
                          width: double.infinity,
                          height: 300.0,
                        ...
                        Container(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              FFAppState().workEvalUploadURLUse =
                                  FFAppState().workEvalUploadFileURL;
                              FFAppState().workevalPlaintext = _model.richtext!;
