...
import 'left_widget_copy_model.dart';
export 'left_widget_copy_model.dart';

class LeftWidgetCopyWidget extends StatefulWidget {
  const LeftWidgetCopyWidget({super.key});

  @override
  State<LeftWidgetCopyWidget> createState() => _LeftWidgetCopyWidgetState();
}

class _LeftWidgetCopyWidgetState extends State<LeftWidgetCopyWidget> {
  late LeftWidgetCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LeftWidgetCopyModel());
